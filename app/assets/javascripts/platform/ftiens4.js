...
{ 
  ...
  if (foldersTree.xID == this.xID && DISPLAYROOT==0) {
	 docW = docW + "<tr style='display:none'>";
  } else {
	 docW = docW + "<tr>";
  }

  docW = docW + leftSide + "<td valign=top>";
...
var PRESERVESTATE = 0;
var ICONPATH = '/assets/platform/treeview/';
var HIGHLIGHT = 0;
